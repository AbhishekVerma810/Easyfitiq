...
@Component({
  ...
  templateUrl: './trainerprogress.page.html',
  styleUrls: ['./trainerprogress.page.scss'],
})
export class TrainerprogressPage {
  userdatas: any[] = [];
  userData: any;
  ...
  navigateclientprogress(userid) {
    this.route.navigate([`/trainer-clientprogress/${userid}`]);
  }
}
